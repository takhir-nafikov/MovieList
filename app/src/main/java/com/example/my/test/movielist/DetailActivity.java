...
import com.example.my.test.movielist.adapters.ReviewAdapter;
import com.example.my.test.movielist.adapters.TrailerAdapter;
import com.example.my.test.movielist.data.FavouriteMovie;
import com.example.my.test.movielist.data.MainViewModel;
import com.example.my.test.movielist.data.Movie;
import com.example.my.test.movielist.data.Review;
import com.example.my.test.movielist.data.Trailer;
